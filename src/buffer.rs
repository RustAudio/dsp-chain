...
impl_dsp_buffer!([f32, ..2], 2, 1)
impl_dsp_buffer!([f32, ..4], 4, 2)
impl_dsp_buffer!([f32, ..8], 8, 4)
impl_dsp_buffer!([f32, ..16], 16, 8)
impl_dsp_buffer!([f32, ..32], 32, 16)
impl_dsp_buffer!([f32, ..64], 64, 32)
impl_dsp_buffer!([f32, ..128], 128, 64)
impl_dsp_buffer!([f32, ..256], 256, 128)
impl_dsp_buffer!([f32, ..512], 512, 256)
impl_dsp_buffer!([f32, ..1024], 1024, 512)
impl_dsp_buffer!([f32, ..2048], 2048, 1024)
impl_dsp_buffer!([f32, ..4096], 4096, 2048)
impl_dsp_buffer!([f32, ..8192], 8192, 4096)
impl_dsp_buffer!([f32, ..16384], 16384, 8192)
