...
impl_dsp_buffer!(f32, 2)
impl_dsp_buffer!(f32, 4)
impl_dsp_buffer!(f32, 8)
impl_dsp_buffer!(f32, 16)
impl_dsp_buffer!(f32, 32)
impl_dsp_buffer!(f32, 64)
impl_dsp_buffer!(f32, 128)
impl_dsp_buffer!(f32, 256)
impl_dsp_buffer!(f32, 512)
impl_dsp_buffer!(f32, 1024)
impl_dsp_buffer!(f32, 2048)
impl_dsp_buffer!(f32, 4096)
impl_dsp_buffer!(f32, 8192)
impl_dsp_buffer!(f32, 16384)
